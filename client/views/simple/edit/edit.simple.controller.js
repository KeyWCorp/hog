      ...
      vm.openGraphInfo = function(ev, graph_data, script)
      {
        $mdDialog.show({
          template:
            ...
            '  </form>' +
            '</md-dialog>',
          controller: SimpleEditGraphInfoController,
      ...
      vm.openInfo = function(ev, filter_type)
      {
        $mdDialog.show({
          template:
            ...
            '  </form>' +
            '</md-dialog>',
          controller: SimpleEditInfoController,
          clickOutsideToClose: true,
          parent: angular.element(document.body),
          targetEvent: ev,
          locals: {
...
function SimpleEditInfoController( $mdDialog, $scope, script_name, info_outputs, outputs, logs, warnings, errors, filter_type, graph_data, openGraphInfo)
{
...
function SimpleEditGraphInfoController($mdDialog, $scope, $timeout, graph_data, script)
{
