      ...
      vm.openGraphInfo = function(ev, idx)
      {
        $mdDialog.show({
          template:
            ...
            '  </form>' +
            '</md-dialog>',
          controller: SimpleListGraphInfoController,
      ...
      vm.openInfo = function(ev, idx, filter_type)
      {
        $mdDialog.show({
          template:
            ...
            '  </form>' +
            '</md-dialog>',
          controller: SimpleListInfoController,
          clickOutsideToClose: true,
          parent: angular.element(document.body),
          targetEvent: ev,
          locals: {
...
function SimpleListInfoController( $mdDialog, $scope, script_name, info_outputs, outputs, logs, warnings, errors, filter_type, graph_data, openGraphInfo, script_index)
{
...
function SimpleListGraphInfoController($mdDialog, $scope, $timeout, graph_data, script)
{
